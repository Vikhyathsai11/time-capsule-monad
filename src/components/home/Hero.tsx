...
const Hero = () => {
  ...
  useEffect(() => {
    ...
    const interval = setInterval(() => {
      ...
      setAnimatedValues({
        ...
        totalTransactions: Math.floor(
          targetValues.totalTransactions * easeProgress
        ),
  ...
  return (
    <div className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden pt-20 bg-black">
      {/* Removed Three.js Background and Images */}
                ...
                {showSecret ? (
                  ...
                  >
                    ...
                    <p className="text-gray-300">
                      &quot; In 2025, ETH will reach $25,000 and transform
                      global finance. &quot;
                    </p>
                  </motion.div>
                ) : (
